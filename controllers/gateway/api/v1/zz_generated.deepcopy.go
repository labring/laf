...
func (in *GatewayStatus) DeepCopyInto(out *GatewayStatus) {
	*out = *in
	if in.AppRoute != nil {
		in, out := &in.AppRoute, &out.AppRoute
		*out = new(GatewayRoute)
		**out = **in
	}
	if in.BucketRoutes != nil {
		in, out := &in.BucketRoutes, &out.BucketRoutes
		*out = make(map[string]*GatewayRoute, len(*in))
		for key, val := range *in {
			var outVal *GatewayRoute
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
	...
	if in.WebsiteRoutes != nil {
		in, out := &in.WebsiteRoutes, &out.WebsiteRoutes
		*out = make(map[string]*GatewayRoute, len(*in))
		for key, val := range *in {
			var outVal *GatewayRoute
			if val == nil {
