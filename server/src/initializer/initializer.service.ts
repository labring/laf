    ...
    await this.db.collection<ResourceBundle>('ResourceBundle').insertMany([
      {
        ...
        spec: {
          ...
          [ResourceType.DedicatedDatabaseCapacity]: { value: 1 },
        },
      ...
      },
      {
        ...
        spec: {
          ...
          [ResourceType.DedicatedDatabaseCapacity]: { value: 4 },
        },
        enableFreeTier: false,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        spec: {
          ...
          [ResourceType.DedicatedDatabaseCapacity]: { value: 16 },
        },
        enableFreeTier: false,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        spec: {
          ...
          [ResourceType.DedicatedDatabaseCapacity]: { value: 64 },
        },
        enableFreeTier: false,
        createdAt: new Date(),
        updatedAt: new Date(),
