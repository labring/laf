...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSSAccess) DeepCopyInto(out *OSSAccess) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSSAccess.
func (in *OSSAccess) DeepCopy() *OSSAccess {
	if in == nil {
		return nil
	}
	out := new(OSSAccess)
